        ...
        <div className="custom-scrollbar max-h-[70vh] overflow-auto p-8">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-blue-600 px-8 py-3 text-xs font-black tracking-widest text-white uppercase shadow-xl transition-all hover:bg-blue-700 active:scale-95 disabled:opacity-50"
            >
