...
/**
 * Convert millimeters to pixels using the standard CSS ratio.
 * In CSS, 1 inch is exactly 96px, and 1 inch is exactly 25.4mm.
 * Therefore, 1mm = 96 / 25.4 pixels.
 * Using this constant ensures stability during pinch-zoom on mobile.
 */
